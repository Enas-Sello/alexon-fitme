...
const CheckOut = () => {
  return (
    <div className="w-full h-screen section__padding ">
        ...
        <div className="flex-1 mb-2">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col md:flex-row gap-6">
              <div className="flex flex-col bg-secColor py-4 px-8 rounded-lg">
              ...
              <div className="flex flex-col border-2 border-dashed border-secColor py-4 px-8 rounded-lg">
          ...
          <div className="mt-10 flex gap-72">
            ...
            <div>
              ...
              <div className="mt-10 font-medium">
                ...
                <input type="text" placeholder="Type you note here" className=' w-80 h-28 p-2 border-2 border-gray-400 rounded-lg mt-8'/>
              </div>
            </div>
          </div>
        </div>
